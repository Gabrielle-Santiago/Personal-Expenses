   ...
   public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, Filter securityFilter) throws Exception {
        return httpSecurity
                ...
                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                    ...
                    .requestMatchers(HttpMethod.POST, "home/add").hasAnyRole("USER", "ADMIN")
                    .requestMatchers(HttpMethod.POST, "add/goals").hasRole("ADMIN")
                    .requestMatchers(HttpMethod.GET, "add/goalsAll").hasRole("ADMIN")
